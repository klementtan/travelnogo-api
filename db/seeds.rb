...
raw_country_code.each do |country_json|
  country = Country.find_by_code(country_json[:code])
  if country.nil?
    country  = Country.create(
      country_name: country_json[:name], code: country_json[:code], all_countries: false
    )
    country.save!
  elsif 
    country.country_name = country_json[:name]
  end
end
